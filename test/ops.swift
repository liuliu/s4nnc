...
final class OpsTests: XCTestCase {
  ...
  func testReduceSum() throws {
    ...
    let a0 = dynamicGraph.variable(Tensor<Float32>([1.1, 2.2, 3.3, 4.4], .NC(2, 2)))
  ...
  func testMinModel() throws {
    ...
    let a0 = dynamicGraph.variable(Tensor<Float32>([1.1, 4.4], .NC(2, 1)))
    let a1 = dynamicGraph.variable(Tensor<Float32>([2.2, 3.3], .NC(2, 1)))
