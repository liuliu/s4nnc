...
extension DataFrame {
  ...
  static func sample(
    ...
    return ccv_cnnp_dataframe_sample_new(
      _dataframe,
      { input, inputSize, data, context, _ in
      ...
      }, index, Int32(size), Unmanaged.passRetained(sampler).toOpaque(),
      { sampler in
  ...
  init(
    ...
    self.init(
      dataframe: _DataFrame(dataframe: sampled, parent: dataframe),
  ...
  static func sample(
    ...
    return ccv_cnnp_dataframe_sample_new(
      ...
      { input, inputSize, data, context, _ in
        ...
        for i in 0..<repeating {
          ...
          case .object:
            for j in 0..<size {
              inputObjects.append(
                Unmanaged<AnyObject>.fromOpaque(input[(i * size + j) % Int(inputSize)]!)
                  .takeUnretainedValue())
            }
          case .tensor:
            for j in 0..<size {
      ...
      { object, _ in
        guard let object = object else { return }
        Unmanaged<AnyObject>.fromOpaque(object).release()
      }, index, Int32(size * repeating), Unmanaged.passRetained(sampler).toOpaque(),
      { sampler in
        Unmanaged<WrappedSampler>.fromOpaque(sampler!).release()
      })!
  }
  ...
  init(
    ...
    for i in 0..<repeating {
      ...
      columnProperties[indexName] = Self.add(
        to: sampled, map: { ($0 as! [AnyObject])[i] }, property: mainProperty,
        outputType: outputType, name: indexName)
    }
    self.init(
      dataframe: _DataFrame(dataframe: sampled, parent: dataframe),
      columnProperties: columnProperties)
    ...
    -> DataFrame
  {
    ...
    if let repeating = repeating, repeating > 1 {
      ...
      if U.self is AnyTensor.Type || U.self == AnyTensor.self {
        ...
        return DataFrame(
          dataframe: dataframe, property: property, size: size, repeating: repeating,
          sample: wrappedSampler, outputType: .tensor)
      } else {
        return DataFrame(
          dataframe: dataframe, property: property, size: size, repeating: repeating,
          sample: wrappedSampler, outputType: .object)
      }
    } else {
      // Use only return type for whether this is a tensor or not.
      if U.self is AnyTensor.Type || U.self == AnyTensor.self {
        // Special handling if this is a tensor, for C-interop, we will unwrap the underlying tensor.
        return DataFrame(
          dataframe: dataframe, property: property, size: size, sample: wrappedSampler,
          outputType: .tensor)
      } else {
        return DataFrame(
          dataframe: dataframe, property: property, size: size, sample: wrappedSampler,
  ...
  public func sample<C0, C1, U0, U1>(
    ...
    if let repeating = repeating, repeating > 1 {
      for i in 0..<repeating {
        ...
        let extractedProperty = DataFrame.add(
          to: sampled, map: { ($0 as! [AnyObject])[i] }, property: mainProperty,
          outputType: .object, name: indexName)
        let name0 = String(
          cString: ccv_cnnp_dataframe_column_name(_dataframe, Int32(properties[0].index))!)
        let indexName0 = "\(name0)_\(i)"
        let outputType0: DataFrame.ColumnProperty.PropertyType =
          (U0.self is AnyTensor.Type || U0.self == AnyTensor.self) ? .tensor : .object
        columnProperties[indexName0] = DataFrame.add(
          to: sampled, map: { ($0 as! (U0, U1)).0 as AnyObject }, property: extractedProperty,
          outputType: outputType0, name: indexName0)
        let name1 = String(
          cString: ccv_cnnp_dataframe_column_name(_dataframe, Int32(properties[1].index))!)
        let indexName1 = "\(name1)_\(i)"
        let outputType1: DataFrame.ColumnProperty.PropertyType =
          (U1.self is AnyTensor.Type || U1.self == AnyTensor.self) ? .tensor : .object
        columnProperties[indexName1] = DataFrame.add(
          to: sampled, map: { ($0 as! (U0, U1)).1 as AnyObject }, property: extractedProperty,
          outputType: outputType1, name: indexName1)
      }
    } else {
      let name0 = String(
        cString: ccv_cnnp_dataframe_column_name(_dataframe, Int32(properties[0].index))!)
      let outputType0: DataFrame.ColumnProperty.PropertyType =
        (U0.self is AnyTensor.Type || U0.self == AnyTensor.self) ? .tensor : .object
      columnProperties[name0] = DataFrame.add(
        to: sampled, map: { ($0 as! (U0, U1)).0 as AnyObject }, property: mainProperty,
        outputType: outputType0, name: name0)
      let name1 = String(
        cString: ccv_cnnp_dataframe_column_name(_dataframe, Int32(properties[1].index))!)
      let outputType1: DataFrame.ColumnProperty.PropertyType =
        (U1.self is AnyTensor.Type || U1.self == AnyTensor.self) ? .tensor : .object
      columnProperties[name1] = DataFrame.add(
        to: sampled, map: { ($0 as! (U0, U1)).1 as AnyObject }, property: mainProperty,
        outputType: outputType1, name: name1)
    }
    return DataFrame(
      dataframe: _DataFrame(dataframe: sampled, parent: dataframe),
      columnProperties: columnProperties)
    ...
    if let repeating = repeating, repeating > 1 {
      for i in 0..<repeating {
        ...
        let outputType0: DataFrame.ColumnProperty.PropertyType =
          (U0.self is AnyTensor.Type || U0.self == AnyTensor.self) ? .tensor : .object
        columnProperties[indexName0] = DataFrame.add(
          to: sampled, map: { ($0 as! (U0, U1, U2)).0 as AnyObject }, property: extractedProperty,
          outputType: outputType0, name: indexName0)
        let name1 = String(
          cString: ccv_cnnp_dataframe_column_name(_dataframe, Int32(properties[1].index))!)
        let indexName1 = "\(name1)_\(i)"
        let outputType1: DataFrame.ColumnProperty.PropertyType =
          (U1.self is AnyTensor.Type || U1.self == AnyTensor.self) ? .tensor : .object
        columnProperties[indexName1] = DataFrame.add(
          to: sampled, map: { ($0 as! (U0, U1, U2)).1 as AnyObject }, property: extractedProperty,
          outputType: outputType1, name: indexName1)
        let name2 = String(
          cString: ccv_cnnp_dataframe_column_name(_dataframe, Int32(properties[2].index))!)
        let indexName2 = "\(name2)_\(i)"
        let outputType2: DataFrame.ColumnProperty.PropertyType =
          (U2.self is AnyTensor.Type || U2.self == AnyTensor.self) ? .tensor : .object
        columnProperties[indexName2] = DataFrame.add(
          to: sampled, map: { ($0 as! (U0, U1, U2)).2 as AnyObject }, property: extractedProperty,
          outputType: outputType2, name: indexName2)
      }
    } else {
      let name0 = String(
        cString: ccv_cnnp_dataframe_column_name(_dataframe, Int32(properties[0].index))!)
      let outputType0: DataFrame.ColumnProperty.PropertyType =
        (U0.self is AnyTensor.Type || U0.self == AnyTensor.self) ? .tensor : .object
      columnProperties[name0] = DataFrame.add(
        to: sampled, map: { ($0 as! (U0, U1, U2)).0 as AnyObject }, property: mainProperty,
        outputType: outputType0, name: name0)
      let name1 = String(
        cString: ccv_cnnp_dataframe_column_name(_dataframe, Int32(properties[1].index))!)
      let outputType1: DataFrame.ColumnProperty.PropertyType =
        (U1.self is AnyTensor.Type || U1.self == AnyTensor.self) ? .tensor : .object
      columnProperties[name1] = DataFrame.add(
        to: sampled, map: { ($0 as! (U0, U1, U2)).1 as AnyObject }, property: mainProperty,
        outputType: outputType1, name: name1)
      let name2 = String(
        cString: ccv_cnnp_dataframe_column_name(_dataframe, Int32(properties[2].index))!)
      let outputType2: DataFrame.ColumnProperty.PropertyType =
        (U2.self is AnyTensor.Type || U2.self == AnyTensor.self) ? .tensor : .object
      columnProperties[name2] = DataFrame.add(
        to: sampled, map: { ($0 as! (U0, U1, U2)).2 as AnyObject }, property: mainProperty,
        outputType: outputType2, name: name2)
    }
    return DataFrame(
      dataframe: _DataFrame(dataframe: sampled, parent: dataframe),
      columnProperties: columnProperties)
    ...
    if let repeating = repeating, repeating > 1 {
      for i in 0..<repeating {
        ...
        let outputType0: DataFrame.ColumnProperty.PropertyType =
          (U0.self is AnyTensor.Type || U0.self == AnyTensor.self) ? .tensor : .object
        columnProperties[indexName0] = DataFrame.add(
          to: sampled, map: { ($0 as! (U0, U1, U2, U3)).0 as AnyObject },
          property: extractedProperty, outputType: outputType0, name: indexName0)
        let name1 = String(
          cString: ccv_cnnp_dataframe_column_name(_dataframe, Int32(properties[1].index))!)
        let indexName1 = "\(name1)_\(i)"
        let outputType1: DataFrame.ColumnProperty.PropertyType =
          (U1.self is AnyTensor.Type || U1.self == AnyTensor.self) ? .tensor : .object
        columnProperties[indexName1] = DataFrame.add(
          to: sampled, map: { ($0 as! (U0, U1, U2, U3)).1 as AnyObject },
          property: extractedProperty, outputType: outputType1, name: indexName1)
        let name2 = String(
          cString: ccv_cnnp_dataframe_column_name(_dataframe, Int32(properties[2].index))!)
        let indexName2 = "\(name2)_\(i)"
        let outputType2: DataFrame.ColumnProperty.PropertyType =
          (U2.self is AnyTensor.Type || U2.self == AnyTensor.self) ? .tensor : .object
        columnProperties[indexName2] = DataFrame.add(
          to: sampled, map: { ($0 as! (U0, U1, U2, U3)).2 as AnyObject },
          property: extractedProperty, outputType: outputType2, name: indexName2)
        let name3 = String(
          cString: ccv_cnnp_dataframe_column_name(_dataframe, Int32(properties[3].index))!)
        let indexName3 = "\(name3)_\(i)"
        let outputType3: DataFrame.ColumnProperty.PropertyType =
          (U3.self is AnyTensor.Type || U3.self == AnyTensor.self) ? .tensor : .object
        columnProperties[indexName3] = DataFrame.add(
          to: sampled, map: { ($0 as! (U0, U1, U2, U3)).3 as AnyObject },
          property: extractedProperty, outputType: outputType3, name: indexName3)
      }
    } else {
      let name0 = String(
        cString: ccv_cnnp_dataframe_column_name(_dataframe, Int32(properties[0].index))!)
      let outputType0: DataFrame.ColumnProperty.PropertyType =
        (U0.self is AnyTensor.Type || U0.self == AnyTensor.self) ? .tensor : .object
      columnProperties[name0] = DataFrame.add(
        to: sampled, map: { ($0 as! (U0, U1, U2, U3)).0 as AnyObject }, property: mainProperty,
        outputType: outputType0, name: name0)
      let name1 = String(
        cString: ccv_cnnp_dataframe_column_name(_dataframe, Int32(properties[1].index))!)
      let outputType1: DataFrame.ColumnProperty.PropertyType =
        (U1.self is AnyTensor.Type || U1.self == AnyTensor.self) ? .tensor : .object
      columnProperties[name1] = DataFrame.add(
        to: sampled, map: { ($0 as! (U0, U1, U2, U3)).1 as AnyObject }, property: mainProperty,
        outputType: outputType1, name: name1)
      let name2 = String(
        cString: ccv_cnnp_dataframe_column_name(_dataframe, Int32(properties[2].index))!)
      let outputType2: DataFrame.ColumnProperty.PropertyType =
        (U2.self is AnyTensor.Type || U2.self == AnyTensor.self) ? .tensor : .object
      columnProperties[name2] = DataFrame.add(
        to: sampled, map: { ($0 as! (U0, U1, U2, U3)).2 as AnyObject }, property: mainProperty,
        outputType: outputType2, name: name2)
      let name3 = String(
        cString: ccv_cnnp_dataframe_column_name(_dataframe, Int32(properties[3].index))!)
      let outputType3: DataFrame.ColumnProperty.PropertyType =
        (U3.self is AnyTensor.Type || U3.self == AnyTensor.self) ? .tensor : .object
      columnProperties[name3] = DataFrame.add(
        to: sampled, map: { ($0 as! (U0, U1, U2, U3)).3 as AnyObject }, property: mainProperty,
        outputType: outputType3, name: name3)
    }
    return DataFrame(
      dataframe: _DataFrame(dataframe: sampled, parent: dataframe),
      columnProperties: columnProperties)
