...
public protocol Loss {
  func callAsFunction<T: DynamicGraph.AnyTensorGroup>(_ input: T, target: T, streamContext: StreamContext?) -> [T.AnyTensor]
}

public extension Loss {
  func callAsFunction<T: DynamicGraph.AnyTensorGroup>(_ input: T, target: T) -> [T.AnyTensor] {
...
public struct SoftmaxCrossEntropyLoss: Loss {
  ...
  public func callAsFunction<T: DynamicGraph.AnyTensorGroup>(_ input: T, target: T, streamContext: StreamContext?) -> [T.AnyTensor] {
